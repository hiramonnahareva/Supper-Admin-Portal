...
const Sidebar = ({ activeTab, handleTabClick, isSidebarOpen }: any) => {
  return (
    <div
      className={`bg-white shadow-md p-6 transition-transform duration-300 ease-in-out ${
    ...
    >
      ...
      >
        ...
        <FaChevronRight
          className={`${
            activeTab === "Clinics" ? "text-white" : "text-gray-500"
          }`}
        />
      </div>
    </div>
